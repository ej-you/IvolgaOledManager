...
// // NewTemplImage returns a new instance of Image.
// func NewTemplImage(active <-chan bool, btnHandlersReg func(),
// 	storage pubsub.Storage, image *entity.Image, screenName string) *TemplImage {
...
// func (i *TemplImage) Ready() <-chan struct{} {
// 	return i.ready
// }

// // StartWithShutdown starts screen service.
// // It can be stopped by cancellaiton the given context.
// func (i *TemplImage) StartWithShutdown(ctx context.Context) error {

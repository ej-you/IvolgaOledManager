...
// NewSensordataRepoDB returns a new instance of SensordataRepo.
func NewSensordataRepoDB(dbStorage *gorm.DB) *SensordataRepo {
...
func (r *SensordataRepo) getSensorResult(cond string) (float64, error) {
	var result float64
	err := r.dbStorage.
		Table("data").
		Select("param_value").
